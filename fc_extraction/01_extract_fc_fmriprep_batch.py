...
def parse_args() -> argparse.Namespace:
    ...
    default_output_root = default_script_dir / "双图谱批量提取结果"

    parser = argparse.ArgumentParser(description="批量提取 Brainnetome246 + AAL116 的 ROI 时序和 FC")
    parser.add_argument(
        "--data_roots", nargs="+",
        default=[r"E:\E_zhangzhihui\从yv那边提取\数据复制-BIDS"],
        help="一个或多个待扫描的 BIDS 根目录"
    )
